    ...
    <>
      <div className="right-content w-100">
        <div className="row dashboardBoxWrapperRow">
          ...
          <div className="box-row col-md-4 topPart2 ">
            <div className="box graphBox">
              ...
              <h3 className="text-white font-weight-bold pl-10">
                $3,787,681.00
              </h3>
              ...
              <tbody>
                {tablerows.map((tablerow, index) => (
                  <tr
                    key={index}
                    style={{
                      backgroundColor: index % 2 === 0 ? "#b2b1b1" : "#e0e0e0",
                    }}
                  >
                    ...
                    <td ms-0>
                      <div className="actions d-flex align-items-center align">
                        <Link to="/product/details">
                          <Button className="secondary dark" color="secondary">
                            <IoEyeSharp />
                          </Button>
                        </Link>

                        <Button className="success dark" color="success">
                          <FaPencil />
                        </Button>
                        <Button className="error dark " color="error">
                          <MdDelete />
                        </Button>
                      </div>
                    </td>
