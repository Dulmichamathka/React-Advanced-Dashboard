...
const ProductDetails = () => {
  ...
  const reviews = [
    ...
    {img : 'https://img.freepik.com/free-photo/close-up-smiley-man-traveling_23-2149272090.jpg', name: 'Cristian Fenando' , time:'15',style: { width: "90%", marginLeft: "auto "},value: 3.5},
    {img : 'https://img.freepik.com/free-photo/portrait-female-tourist-visiting-great-wall-china_23-2151261823.jpg', name: 'Anjalina rose' , time:'20',style: { width: "90%", marginLeft: "auto "},value: 5.0},
    {img : 'https://img.freepik.com/free-photo/beautiful-woman-street_23-2147654273.jpg', name: 'Geogyana marcob' , time:'25',value :4.0},
  ]
        ...
        <div className="card productDetailsSection ">
          <div className="row">
            <div className="col-md-5 ">
              ...
              <div className="sliderWrapper ">
                <h6 className='mb-4 mt-1 fw-bold'>Product Gallery</h6>
                  <Slider {...productSliderOptions}  ref={productSliderBig} className='first-slide mb-2'>
                  ...
                  <Slider {...productSliderSmlOptions} ref={productSliderSml} className='second-slide'>
            ...
            <div className="col-md-7">
                <div className="sideSliderWrapper">
                    ...
                    <h4>Formal suits for men normal dressing slim fit one piece dress</h4>
                    ...
                    <div className="row" >
                      ...
                      <div className="col-sm-3 d-flex align-items-center side-content-left"> 
                        <span className="icon"> <MdPriceChange/></span>      
                        <span className="name">Price</span>
                      </div>

                      <div className="col-sm-9 side-content-right">  
                      : <span>$37.00  <del className='text-danger'>$42.00</del></span>    
                      </div>
             ...
             <div className="ratingSectionOne ">
                    ...
                    {   ratings.map((rating,index) =>(
                      ...
                      <div className="col2">
                        ...
                        <div className="progress-bar" style={{ width: rating.width }}></div>
                        </div>
                      </div>
                          ...
                          <div className="row" >
                             <div > 
                                   <div className="userInfo d-flex  align-items-center mb-3 w-100">
                                       ...
                                       <Button  className ="btn-blue btn-lg ms-auto btn-big" > <MdReply />REPLY</Button>    
                                     </div>
     
                                   <Rating name="read-only" value={review.value} precision={0.5} readOnly />   
          ...
          <br/>
              ...
              <form  className="reviewReplyForm">
                  <textarea placeholder="write here " className='mb-4  '> 
                  </textarea>  
